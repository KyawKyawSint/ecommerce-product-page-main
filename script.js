...
const closeIconTag = document.querySelector(".closeIcon");
let emptyCartBtn;
        ...
        <div class="cartContentFull">
            <div class="cartContentProduct">
                ...
                <div class="cartContentProdText">
                    ...
                    <div class="cartContentProdPrice">$125.00 * ${qtyValue} <span class="totalPrice">$${125.00 * qtyValue}</span></div>
                </div>
